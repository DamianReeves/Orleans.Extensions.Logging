...
task Clean -depends clean-directories, clean-source-projects, clean-test-projects
...
task Compile -depends nuget-restore, compile-source-projects, compile-test-projects
...
task version -depends acquire-buildtools {    
    $script:versionInfo = Invoke-GitVersion -UpdateAssemblyInfo -GitVersionExePath $script:GitVersionExe
